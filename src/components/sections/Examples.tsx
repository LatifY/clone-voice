...
const AudioPlayer: React.FC<AudioPlayerProps> = ({ isPlaying, onTogglePlay }) => {
  return (
    <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-3">
      ...
      <div className="flex-1">
        <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
          <div className="h-full bg-white rounded-full transition-all duration-300" style={{ width: '0%' }}></div>
        </div>
      </div>
...
export const Examples: React.FC = () => {
  ...
  const textToSpeechExamples = [
    {
      ...
      prompt: "Through the wormhole of space and time, we discover that the universe holds secrets beyond our wildest imagination.",
      originalVoice: "Morgan Freeman documentary narration",
      audioSrc: '/examples/morgan-freeman.mp3'
    },
    {
      ...
      prompt: "In the heart of the Amazon rainforest, a remarkable species has evolved an extraordinary adaptation to survive.",
    ...
    },
    {
      ...
      prompt: "Yes we can build a better future for our children, a future filled with hope, opportunity, and unlimited potential.",
    ...
    },
    {
      ...
      prompt: "You get to choose your own path in life, and when you choose love over fear, magic happens!",
    ...
    },
    {
      ...
      avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
      prompt: "Today, we're going to revolutionize the way people interact with technology. One more thing... this changes everything.",
    ...
    },
    {
      ...
      prompt: "Education is the most powerful weapon we can use to change the world and empower future generations.",
  ...
  const speechToSpeechExamples = [
    {
      ...
      clonedText: "To innovate or not to innovate, that is the strategic decision we must make",
    ...
    },
    {
      ...
      clonedText: "The pedagogical implications of interactive learning through recreational activities",
    ...
    },
    {
      ...
      originalText: "Hey, so like, there was this crazy thing that happened today",
      clonedText: "Good evening, I'm reporting on the significant events that transpired earlier today",
    ...
    },
    {
      ...
      originalText: "Processing request. System status nominal. Task completed.",
      clonedText: "I'm working on your request right now. Everything looks good, and I've finished the task!",
    ...
    },
    {
      ...
      clonedText: "YOU'VE GOT THIS! Nothing is impossible when you believe in yourself!",
  ...
  return (
    <section id="examples" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-gray-950 to-black relative overflow-hidden border-b-4 border-gray-900">
      ...
      {/* Grain overlay */}
      <div className="absolute inset-0 opacity-12 mix-blend-overlay pointer-events-none" 
           style={{
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Hear the magic of AI voice cloning in action. From celebrity voices to style transformations.
          </p>
        </div>
              ...
              <Card key={example.id} hover className="overflow-hidden">
                <CardBody className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <Badge variant="glass" size="sm">Text Prompt</Badge>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Badge variant="glass" size="sm">Original</Badge>
                      </div>
                      <p className="text-sm text-gray-300 mb-2">"{example.originalText}"</p>
                      <p className="text-xs text-gray-400">{example.originalVoice}</p>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Badge variant="primary" size="sm">AI Transformed</Badge>
                      </div>
                      <p className="text-sm text-gray-300 mb-2">"{example.clonedText}"</p>
                      <p className="text-xs text-white">{example.clonedVoice}</p>
                    </div>
                  </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 text-white">
            ...
            <p className="text-lg text-gray-300 mb-6">
              Start with 10 free credits and experience the magic of AI voice cloning
            </p>
            <Button 
              size="lg"
              variant="primary"
